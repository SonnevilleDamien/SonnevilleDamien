...
Currently in a work-study contract at OKP4 for the end of my Msc in data science, we are working on the development of a decentralized protocol based on the blockchain that will allow to share data and services in order to generate new knowledge.

Passionate about data, and artificial intelligence, I have an interest in deploying solutions as a service, to integrate and deploy the analyzed data with the business application, so I am interested in all languages that allow me to intervene throughout the processing chain,  i.e. problem identification, data collection, processing and deployment to make the model accessible to the end user.
